...
function init () {
  $('.amenities .popover input').change(function () { obj = amenitylist; checkedObjects.call(this, 1); });
  $('.state_input').change(function () { obj = statelist; checkedObjects.call(this, 2); });
  $('.city_input').change(function () { obj = citylist; checkedObjects.call(this, 3); });
  apiStatus();
  searchPlaces();
  showReviews();
}
